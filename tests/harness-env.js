...
vm.runInContext(scoringSrc + '\n;globalThis.__exports = { crowdForecast, plannerScoreBreakdown, skiScoreBreakdown, verdictFromBreakdown, tripWindowSnow, targetForecastIndex, _bluebirdFactor, pickTopPickFromRanked, filterRunnerUpCandidates, isTopPickFloorActive, hasLocalIntent, buildRecommendationRolesFromRanked, pickLocalFromRanked, pickLocalFallbackFromRanked, pickSleeperFromRanked, pickTrapFromRanked, localRoleExplanation, localRoleLabel, sleeperRoleExplanation, trapRoleExplanation, isCredibleLocalCandidate, isCredibleSleeperCandidate, isCredibleTrapCandidate, trapQualifiesForCrowdWatch, pickCrowdWarningCopy, compareLocalCandidates, hasSleeperReason, obviousBigMountainReference, smartPlayReference, sleeperObviousnessIndex, isLessObviousSmartPlay, LOCAL_MAX_DRIVE_MINS, LOCAL_SCORE_CLOSE_BAND, SLEEPER_SCORE_CLOSE_BAND, SLEEPER_CROWD_GAP_MIN, TRAP_QUALITY_MIN_SUIT, TRAP_CROWD_SCORE_MIN, TRAP_DEMAND_METRO_MIN };', sandbox);
