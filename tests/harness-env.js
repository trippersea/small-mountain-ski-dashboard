...
vm.runInContext(scoringSrc + '\n;globalThis.__exports = { crowdForecast, plannerScoreBreakdown, skiScoreBreakdown, verdictFromBreakdown, tripWindowSnow, targetForecastIndex, _bluebirdFactor, pickTopPickFromRanked, findTopPickRunnerUp, buildCloseCallTopPickCopy, closeCallEdgeReason, filterRunnerUpCandidates, isTopPickFloorActive, hasLocalIntent, buildRecommendationRolesFromRanked, pickLocalFromRanked, pickLocalFallbackFromRanked, pickSleeperFromRanked, pickTrapFromRanked, fillMissingRoleSlots, localRoleExplanation, localRoleLabel, sleeperRoleExplanation, trapRoleExplanation, isCredibleLocalCandidate, isCredibleLocalFallbackCandidate, hasLocalFallbackReason, isCredibleSleeperCandidate, isCredibleTrapCandidate, trapQualifiesForCrowdWatch, pickCrowdWarningCopy, compareLocalCandidates, hasSleeperReason, isPickAlreadyQuietPlay, obviousBigMountainReference, smartPlayReference, sleeperObviousnessIndex, isLessObviousSmartPlay, LOCAL_MAX_DRIVE_MINS, LOCAL_SCORE_CLOSE_BAND, LOCAL_FALLBACK_SCORE_BAND, TOP_PICK_CLOSE_CALL_BAND, SLEEPER_SCORE_CLOSE_BAND, SLEEPER_CROWD_GAP_MIN, TRAP_QUALITY_MIN_SUIT, TRAP_CROWD_SCORE_MIN, TRAP_DEMAND_METRO_MIN };', sandbox);
