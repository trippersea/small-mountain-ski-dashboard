...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; }
    ...
    nav { background: #1a2030; border-bottom: 1px solid rgba(255,255,255,.08); padding: 10px 24px; display: flex; align-items: center; gap: 10px; position: sticky; top: 0; z-index: 100; }
