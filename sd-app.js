...
(function injectSponsorCSS() {
  ...
  style.textContent = `
    ...
    /* ── Featured Partner Pill / Book CTA ── */
    .featured-pill {
      background: #edf4ff;
...
<div class="detail-card-inner">
  ...
  <div class="detail-header-rebuilt detail-header-rebuilt--v2" style="display:grid;grid-template-columns:minmax(0,2fr) minmax(280px,1fr);gap:20px;align-items:start">
    <div>
      ...
      <p style="margin-top:12px;font-size:14px;line-height:1.7;color:var(--muted);max-width:60ch">${sponsor && sponsor.tagline ? esc(sponsor.tagline) : esc(detailInsightText(resort, wx, crowd))}</p>
